  ...
  return (
    <>
      <div className="deck-review-intro">
        ...
        <p>
          <strong>How to review:</strong> Your deck info is going to be listed
          below, under that will be all your flashcards! When you click on the
          card, it will show the other side... Just like a real flashcard! It
          will be ordered in a list randomly each time you refresh the page. I
          recommend you start from the top and go down from there and refresh to
          randomize the order. Happy studying!
        </p>
      </div>
      <div className="deck-info-review">
        ...
        <button
          ...
          onClick={() => setShowedCards(shuffleCards())}>
          Shuffle
        </button>
        <button className="change-shown-item" onClick={handleToggleAllCards}>
          Flip All Cards
        </button>
      </div>
